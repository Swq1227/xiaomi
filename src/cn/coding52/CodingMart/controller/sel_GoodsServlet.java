...
@WebServlet(name="sel_GoodsServlet",urlPatterns="/sel_GoodsServlet")
public class sel_GoodsServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		request.getRequestDispatcher("link/admin_sel_Goods.jsp").forward(request, response);
