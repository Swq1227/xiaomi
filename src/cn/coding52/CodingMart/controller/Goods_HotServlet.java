...
@WebServlet(name="Goods_HotServlet",urlPatterns="/Goods_HotServlet")
public class Goods_HotServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		// 再把所有的评论给查询出来
		List<Goods> list = new LGoodsDaoImpl().getAllGoodsinfo2();
