...
@WebServlet(name="upd_typesServlet",urlPatterns="/upd_typesServlet")
public class upd_typesServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		List<Types> list=new Types_managerDaoImpl().getAllTypes();
     	...
     	request.getRequestDispatcher("link/admin_upd_Types.jsp").forward(request, response);
