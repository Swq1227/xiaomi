...
@WebServlet(name="sel_typesServlet",urlPatterns="/sel_typesServlet")
public class sel_typesServlet extends HttpServlet {
...
//     	System.out.println(list);
     	request.getRequestDispatcher("link/admin_sel_Types.jsp").forward(request, response);
