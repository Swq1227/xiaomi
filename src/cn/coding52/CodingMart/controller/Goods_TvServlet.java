...
@WebServlet(name="Goods_TvServlet",urlPatterns="/Goods_TvServlet")
public class Goods_TvServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		// 再把所有的评论给查询出来
		List<Goods> list = new LGoodsDaoImpl().getAllGoodsinfo3();
