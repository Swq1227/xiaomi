...
import cn.coding52.CodingMart.dao.daoimpl.TypesDaoImpl;
import cn.coding52.CodingMart.model.Goods;
import cn.coding52.CodingMart.model.Types;
@WebServlet(name="Type_TYServlet",urlPatterns="/Type_TYServlet")
public class Type_TYServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		// 再把所有的评论给查询出来
		List<Types> list = new TypesDaoImpl().getAllTypeinfo();
