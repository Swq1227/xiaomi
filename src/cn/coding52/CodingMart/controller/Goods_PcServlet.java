...
@WebServlet(name="Goods_PcServlet",urlPatterns="/Goods_PcServlet")
public class Goods_PcServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		// 再把所有的评论给查询出来
		List<Goods> list = new LGoodsDaoImpl().getAllGoodsinfo4();
