		...
		<section id="main-content">
			<section class="wrapper">
				...
				<div class="row" style="text-align:center">
					<div class="col-ld-12">
						<a class="btn btn-primary" href="manager_user_Servlet?page=0">首页</a>&nbsp;&nbsp;
						<a class="btn btn-primary"
							href="manager_user_Servlet?page=${requestScope.page }&type=pre">上一页</a>&nbsp;&nbsp;
						<a class="btn btn-primary"
							href="manager_user_Servlet?page=${requestScope.page }&type=next">下一页</a>&nbsp;&nbsp;
						<a class="btn btn-primary"
							href="manager_user_Servlet?page=${requestScope.count-1 }">末页</a>
					</div>
				</div>
