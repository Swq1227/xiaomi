			  ...
			  <div class="row">
				<div class="col-lg-12">
					<ol class="breadcrumb">
						...
						<li><i class="fa fa-file-text-o"></i>全部商品</li>
					</ol>
				</div>
			</div>
			
			 <div class="row">
				<h3>当前商城共有${number}种商品</h3>
				...
				<div class="row" style="text-align:center">
					<div class="col-ld-12">
						<a class="btn btn-primary" href="sel_GoodsServlet?page=0">首页</a>&nbsp;&nbsp;
						<a class="btn btn-primary"
							href="sel_GoodsServlet?page=${requestScope.page }&type=pre">上一页</a>&nbsp;&nbsp;
						<a class="btn btn-primary"
							href="sel_GoodsServlet?page=${requestScope.page }&type=next">下一页</a>&nbsp;&nbsp;
						<a class="btn btn-primary"
							href="sel_GoodsServlet?page=${requestScope.count-1 }">末页</a>
					</div>
			</div>
