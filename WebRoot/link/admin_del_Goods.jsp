      ...
      <section id="main-content">
          <section class="wrapper">            
			  ...
			  <div class="row">
				<div class="col-lg-12">
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="admin_manager_main.html">后台管理</a></li>
						<li><i class="icon_document_alt"></i>商品管理</li>
						<li><i class="fa fa-file-text-o"></i>删除商品</li>
					</ol>
				</div>
			</div>
			
			 <div class="row">
				<h3>当前商城共有${number}商品</h3>
					<div class="row" style="text-align:center"><h4>共${count}页，当前为第${page+1}页</h4></div>
					<div class="col-md-12">
								...
								<tbody>
									<c:forEach var="list" items="${requestScope.list }"
										...
										<tr>
											...
											<td>${list.getGid()}</td>
											<td>${list.getGname() }</td>
											<td>${list.getGcontent() }</td>
											<td>${list.getGprice() }</td>
											<td>${list.getGnum() }</td>
											<td>${list.getTid() }</td>
										</tr>
									</c:forEach>
				...
				<div class="row" style="text-align:center">
					<div class="col-ld-12">
						<a class="btn btn-primary" href="del_GoodsServlet?page=0">首页</a>&nbsp;&nbsp;
						<a class="btn btn-primary"
							href="del_GoodsServlet?page=${requestScope.page }&type=pre">上一页</a>&nbsp;&nbsp;
						<a class="btn btn-primary"
							href="del_GoodsServlet?page=${requestScope.page }&type=next">下一页</a>&nbsp;&nbsp;
						<a class="btn btn-primary"
							href="del_GoodsServlet?page=${requestScope.count-1 }">末页</a>
					</div>
			</div>
       			...
       			<!-- 让用户去选择 -->
					...
					<div class="form-group">
						<label class="control-label col-lg-2" for="title">请在文本框中输入要删除商品的id</label>
						<div class="col-md-10">
							<input type="text" class="form-control" id="t_id">
						</div>
						<div class="col-md-10">
							<button type="submit" class="btn btn-primary" id="makesure">确认删除</button>
						</div>
					</div>
				</div>
