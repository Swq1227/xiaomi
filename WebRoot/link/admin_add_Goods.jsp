				...
				<div class="row">
					<div class="col-lg-12">
						<ol class="breadcrumb">
							...
							<li><i class="fa fa-file-text-o"></i>添加商品</li>
						</ol>
					</div>
				</div>
					...
					<div class="">
						...
						<form class="form-horizontal">
							...
							<div class="form-group">
								<label class="control-label col-lg-2" for="g_name">商品名</label>
								<div class="col-lg-10">
							...
							<!-- g_content -->
							<div class="form-group">
								<label class="control-label col-lg-2" for="g_content">商品简介</label>
								<div class="col-lg-10">
							...
							<!-- g_content -->
							<div class="form-group">
								<label class="control-label col-lg-2" for="g_rate">商品热门评价</label>
								<div class="col-lg-10">
							...
							<!-- g_num -->
							<div class="form-group">
								<label class="control-label col-lg-2" for="g_num">商品库存</label>
								<div class="col-lg-10">
							...
							<!-- Tags -->
							<div class="form-group">
								<label class="control-label col-lg-2" for="exampleInputFile">上传商品图像</label>
							...
							<div class="form-group">
								...
								<div class="col-lg-offset-2 col-lg-9">
									<button type="submit" id="makesure" class="btn btn-primary">添加</button>
